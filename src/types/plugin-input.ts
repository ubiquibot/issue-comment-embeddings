...
export const pluginSettingsSchema = T.Object(
  {
    ...
    redactPrivateRepoComments: T.Boolean({ default: false, description: "When true, redacts markdown content and payload for private repository comments and issues." }),
  },
  { default: {} }
);
